...
const OrderReceivedEmail = ({shippingAddress, orderId, orderDate, }: {shippingAddress: ShippingAddress, orderId: string, orderDate: string }) => {
    ...
    const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://jscobracase.vercel.app'
                ...
                <Container style={container}>
                    <Section style={message}>
                        ...
                        <Text style={global.text}>
                            We will prepare everything for delivery and will notify you once
